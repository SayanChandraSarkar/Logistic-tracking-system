...
$data = validateGet([], ["counts", "history30", "distrubution7"]);
...
// }
// last 7 days, distrubution
if (isset($data['distrubution7'])) {
	$res['distrubution7'] = $db->select("status, COUNT(id) as counts", "tracking", "ts_created>$time_7days_ago GROUP BY status");
}
