...
head([
  "title" => "BlueWave | Logicstic Shipping Company",
  "description" => "BlueWave is a provider of comprehensive logistics and transportation solutions. Established in 2014 as an express operator, the company rapidly transformed itself into a global brand recognized for its customized services and innovative multi-product offering",
  "url" => "",
]);
?>
</head>
        ...
        <div class="col-lg-7">
          <div class="track-shipping-form">
            <div class="inner">
              ...
              <p class="mt-4">
                <i class"lni-support-lni"></i> Need any help? <a href="/contact" class="tdu">Write to us</a>
              </p>
            </div>
          </div>
        </div>
